...
export default function Home() {
  ...
  return <><PageMeta title="Saturn — A Cassini Explorer" description="Explore real Cassini observations of Saturn’s rings. Compare exact samples, follow a question, and save your research notes." />
    <section className="home-hero" aria-labelledby="home-title"><div className="hero-copy"><p className="mission-tag"><span />MIT PRIMES <span className="tag-divider">/</span> 2026</p><h1 id="home-title">Every ring.<br /><em>A new question.</em></h1><p className="hero-description">Look closer at Saturn through real Cassini data.<br className="desktop-break" /> Follow a signal. Make an observation.<br className="desktop-break" /> Keep exploring.</p><div className="hero-actions"><Link to="/data" className="hero-action"><span>Explore the rings</span><Arrow /></Link><Link to={last ? explorationHref(last) : '/explorations'} className="hero-action"><span>{last ? 'Continue exploring' : 'My notebook'}</span><Arrow /></Link><Link to="/research" className="hero-action"><span>Project research</span><Arrow /></Link></div><div className="hero-facts"><div><strong>06</strong><span>Observations</span></div><div><strong>03</strong><span>Signal variables</span></div><div><strong>NASA</strong><span>PDS source data</span></div></div></div><div className="planet-caption" aria-hidden="true"><span>SATURN</span><span>RINGS, SEEN DIFFERENTLY</span></div></section>
    <SignalPreview />
  </>
}
